...
dataset_path='/Users/crista/Documents/Michigan/Classes/LEAP/source_code/LEAP/deep_learning_sentiment_analysis/aclImdb/'
...
def tokenize(sentences):
    ...
    print 'Tokenizing..',
    text = "\n".join(sentences)
    print "TOKENIZER_CMD", tokenizer_cmd
    ps = subprocess.Popen(['ps', 'aux'], stdout=subprocess.PIPE).communicate()[0]
    print "DONE 1"
    tokenizer = subprocess.Popen(tokenizer_cmd, stdin=subprocess.PIPE, stdout=subprocess.PIPE)
...
def main():
    ...
    path = dataset_path
    print "PATH", path
    print "OS PATH", os.path.join(path, 'train')
